...
urlpatterns = [
    ...
    path('posts/', PostListView.as_view(), name='post-list'),  # Add this line for post list
    ...
    path('comment/<int:pk>/update/', edit_comment, name='comment-update'),  # Update a comment
